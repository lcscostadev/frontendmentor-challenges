    ...
    return (
        <>
            <section className='text-center px-10 pt-14 relative'>
                <h1 className='text-[2rem] max-w-[500px] mx-auto text-white  font-[Ubuntu]'>A modern publishing platform</h1>
                <p className='max-w-[300px] mx-auto font-[Overpass] text-[1.1rem] opacity-75 pt-4 pb-8 text-white'>Grow your audience and build your online brand</p>
